...
interface PatientDeletePopUpProps {
...
export function PatientDeletePopUp({
  patient,
  updateFunc,
  cancelFunc,
  className,
}: PatientDeletePopUpProps) {
  ...
  return (
    <>
      <div className={className}>
        ...
        >
          <p className={"text-center font-medium text-lg"} >Are you sure you want to delete this patient?</p>
          <p className={"text-center"}>{patient.name} : {patient.id}</p>
