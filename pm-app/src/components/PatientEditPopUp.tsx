...
export function PatientEditPopUp({patient, updateFunc, className, cancelFunc}: PatientEditPopUpProps){
	...
	return (
		<>
			<div className={className}>
				<div className={"m-auto w-4/5 max-w-md rounded-3xl transition-all duration-100 bg-white shadow-2xl p-8 " + loadingFilter}>
					<div className="flex items-center justify-between">
						<div className={"w-1/3"}>
							<label htmlFor="patientName" className={"p-4"}>Name</label>
						</div>
						...
						} className={"border-1 border-gray-300 p-1 pl-3 rounded-2xl m-1 w-2/3"}
						/>
					</div>
					<div className="flex items-center justify-between">
						<div className={"w-1/3"}>
							<label htmlFor="patientEmail" className={"p-4"}>Email</label>
						</div>
					...
					<div className="flex items-center justify-between">
						<div className={"w-1/3"}>
							<label htmlFor="patientAddress" className={"p-4"}>Address</label>
						</div>
					...
					<div className={"flex items-center justify-between"}>
						<div className={"w-1/3"}>
							<label htmlFor="patientDateOfBirth" className={"p-4"}>Date of birth</label>
						</div>
